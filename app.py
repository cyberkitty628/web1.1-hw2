...
def show_froyo_results():
    """Shows the user their Fro-Yo order form results."""
...
def favorites_results():
    ...
    # Get users favorite things based on what they entered in the forms
...
def secret_message():
    ...
    <form action="/message_results" method="POST">
        Enter your top secret message:<br/>
...
def message_results():
    ...
    # Get users message from the form & use sort_letters to scramble letters
    secret_message = request.form.get('message')
    return f'Your secret message is {sort_letters(secret_message)}.' 
...
def horoscope_results():
    ...
    # Get user's name to greet them on result page
